...
func init() {
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦dc3353a9:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/bozkurtemre/go-service-weaver-template/internal/example/Service⟧\n⟦f105e4b1:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→frontend⟧\n",
	})
}
